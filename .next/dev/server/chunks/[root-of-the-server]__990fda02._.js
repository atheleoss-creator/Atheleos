...
"[project]/app/api/messages/[conversationId]/typing/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE conversation_participants SET last_typing_at = NOW() WHERE conversation_id = ? AND user_id = ?', [
            conversationId,
            userId
        ]).catch(async (err)=>{
            // Auto-migrate if column doesn't exist
            if (err.code === 'ER_BAD_FIELD_ERROR' || err.message?.includes("Unknown column")) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`ALTER TABLE conversation_participants ADD COLUMN last_typing_at DATETIME NULL`);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE conversation_participants SET last_typing_at = NOW() WHERE conversation_id = ? AND user_id = ?', [
                    conversationId,
                    userId
                ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__990fda02._.js.map