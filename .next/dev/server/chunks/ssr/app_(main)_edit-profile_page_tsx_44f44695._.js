module.exports = [
"[project]/app/(main)/edit-profile/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditProfilePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (user?.username) {
            fetch(`/api/profile/${user.username}`).then((res)=>res.json()).then((data)=>{
...
//# sourceMappingURL=app_%28main%29_edit-profile_page_tsx_44f44695._.js.map