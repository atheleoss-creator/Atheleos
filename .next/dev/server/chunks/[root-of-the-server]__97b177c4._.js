...
async function GET() {
    try {
        ...
        try {
            ...
            const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id, username, full_name, avatar_url, cover_url, bio, is_verified, verification_level, role, public_key FROM users WHERE id = ?', [
                decoded.id
            ]);
            if (users.length === 0) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__97b177c4._.js.map