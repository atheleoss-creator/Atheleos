...
"[project]/app/api/follow/list/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        let sql = '';
        const followCheck = currentUserId ? `EXISTS(SELECT 1 FROM follows WHERE follower_id = ${currentUserId} AND following_id = u.id) AS is_following` : '0 AS is_following';
        if (type === 'followers') {
            sql = `
        ...
        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(sql, [
            parseInt(userId)
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00cf908c._.js.map