...
async function sendOTP(to, otp, purpose = 'signup') {
    ...
    const html_signup = `
        <div style="font-family: Arial, sans-serif; padding: 40px; text-align: center; background-color: #050505; color: white;">
            <h1 style="color: #E5C158; letter-spacing: 2px;">ATHELEOS</h1>
...
async function POST(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE users SET otp_code = ?, otp_expires_at = ? WHERE id = ?', [
            otp,
            expiresAt,
            user.id
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c046093d._.js.map