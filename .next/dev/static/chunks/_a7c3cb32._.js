                    ...
                    try {
                        ...
                        if (res.ok) {
                            ...
                            if (!localPrivKey) {
                                ...
                                try {
                                    const keyPair = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crypto$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateKeyPair"])();
                                    const privateKeyBase64 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crypto$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exportKey"])(keyPair.privateKey, 'pkcs8');
                                    const publicKeyBase64 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crypto$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exportKey"])(keyPair.publicKey, 'spki');
                                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$crypto$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["KeyStore"].savePrivateKey(privateKeyBase64);
                                    ...
                                    setUser({
                                        "AuthProvider.useEffect.checkSession": (prev)=>prev ? {
                                                ...prev,
                                                publicKey: publicKeyBase64
                                            } : prev
...
const SocketProvider = ({ children })=>{
    ...
    const failCountRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const isUserOnline = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SocketProvider.useCallback[isUserOnline]": (id)=>onlineUsers.has(id.toString())
...
_s1(SocketProvider, "WJDX4ffD0mZY2EV+mAnJjKliKKk=", false, function() {
    return [
...
function NotificationProvider({ children }) {
    ...
    const removeToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotificationProvider.useCallback[removeToast]": (id)=>{
            setToasts({
                "NotificationProvider.useCallback[removeToast]": (prev)=>prev.filter({
                        "NotificationProvider.useCallback[removeToast]": (t)=>t.id !== id
                    }["NotificationProvider.useCallback[removeToast]"])
            }["NotificationProvider.useCallback[removeToast]"]);
        }
    }["NotificationProvider.useCallback[removeToast]"], []);
    const showToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotificationProvider.useCallback[showToast]": (type, title, message, duration = 4000)=>{
            ...
            setToasts({
                "NotificationProvider.useCallback[showToast]": (prev)=>{
                    // Keep max 5 toasts
                    const next = [
                        ...prev,
                        toast
            ...
            }["NotificationProvider.useCallback[showToast]"]);
            // Auto-dismiss
            setTimeout({
                "NotificationProvider.useCallback[showToast]": ()=>{
                    removeToast(id);
                }
            }["NotificationProvider.useCallback[showToast]"], duration);
        }
    }["NotificationProvider.useCallback[showToast]"], [
        removeToast
    ]);
...
_s(NotificationProvider, "TOml9E0LTTiYN1N9gOMjoQwLkbc=");
...
/* ─── Single Toast Item ─── */ function ToastItem({ toast, index }) {
    _s();
    const { removeToast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotification"])();
    ...
    const touchDeltaX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ToastItem.useEffect": ()=>{
            ...
            }["ToastItem.useEffect.interval"], 50);
            return ({
...
_s(ToastItem, "xXZup5Xvuc29mBfMjPnU4iMEE2U=", false, function() {
    return [
...
function NotificationToast() {
    _s1();
    const { toasts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotification"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            toasts.map((toast, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ToastItem, {
                    toast: toast,
                    index: idx
                }, toast.id, false, {
                    fileName: "[project]/components/NotificationToast.tsx",
...
_s1(NotificationToast, "5uWkpKpkLEdyP8T/ksu2lUe4wns=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotification"]
    ];
});
...
__turbopack_context__.k.register(_c1, "NotificationToast");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_a7c3cb32._.js.map